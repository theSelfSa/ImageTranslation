...
do
    ...
    python train.py --dataroot "$dataroot" --name "$name" --model pix2pix --direction AtoB --gan_mode lsgan --n_epochs "$n_epochs" --n_epochs_decay "$n_epochs_decay" --run_number "$run"
